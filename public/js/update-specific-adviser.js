    ...
    ({
      ...
      success: function (data)
      {
        if (!isNaN (data.identifier) && data.identifier != null)
        {
          ...
          ({
            type: "post",
            url: "../controllers/read-specific-adviser-to-update.php",
        ...
        {
          console.log ("Nothing");
          window.location.href = "update-advisers.php";
        }
      },
    ...
    (
      function (event)
      {
        ...
        $("input[name=last-name]").val () != ""))
        {
          ...
          ({
            type: "post",
            url: "../controllers/apply-adviser-update.php",
