...
<html>
  ...
  <body>
    <header id = "form-header">
      <div class = "container">
        <h2 id = "h2-title">Update author</h2>
      </div>
    </header
    <div class = "container">
      <div class = "main row">
    	        ...
    	        <tr>
                   ...
                   <div class = "container button-container">
                     <div class = "main row">
                       ...
                       <div class = "col-xs-6 col-sm-6 col-md-6 col-lg-6">
    	  				         <input class = "btn btn-lg btn-danger button-width center-block" type = "reset" value = "Back" onclick = "document.location='update-authors.php'" />
                       </div>
                     </div>
                   </div>
                 </td>
    ...
    <script src = "../public/js/update-specific-author.js"></script>
  </body>
</html>
